...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'tbl_cargos' | 'tbl_carrinho' | 'tbl_categorias_produtos' | 'tbl_compras' | 'tbl_funcionarios' | 'tbl_pet' | 'tbl_produtos' | 'tbl_servicos' | 'tbl_sexo' | 'tbl_taxonomia' | 'tbl_usuario' | 'tbl_servico_criado'
